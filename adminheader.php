...
<header>
    <nav class="nav navbar navbar-expand-md bg-pink navbar-dark"  role ="navigation">
        ...
        <nav class ="collapse navbar-collapse" id="navbar" aria-label="navbar">
            ...
            <ul class ="nav navbar-nav ml-auto">
                <li class="nav navbar-nav">
                    <a class ="nav-link" href="process_logout.php" aria-label="logout button"><span class="fas fa-directions">Logout</span></a>
                </li>
            </ul>
        </nav>  
    </nav>          
