...
<html>
    ...
    <body id="aboutUs">
        ...
        // put your code here
        ?>
        <h2 id="txtAboutUs">About Us</h2>
        <section id="About Us" class="col-md-6">
            <h3 class="abtUsHeading">About KUUUEEEH</h1>
            ...
            <h3 class="abtUsHeading">Why Choose KUUUEEEH?</h2>
            ...
            <h3 class="abtUsHeading">What kuehs are we selling?</h2>
            <p>Our menu offers a wide range of kuehs that you, your family and friends are surely craving for!</p>
            <p>Some of our signature kuehs from our menu includes: Ang Ku Kueh, Chwee Kueh, Soon Kueh, Kueh Tako etc that are highly recommended for y'all to try out!</p>
            <p id="bon_appetit">"Bon Appétit!"</p>
        </section>
        <section id="Images" class="col-md-6">
            <img src="img/sample_cake.png"/>
        </section>
    </body>
</html>